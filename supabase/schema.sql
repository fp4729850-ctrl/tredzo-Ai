...
-- ALTER ROLE "authenticator" WITH NOINHERIT NOCREATEROLE NOCREATEDB LOGIN NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:ReSvKB/8YMs9ybnIkE3l5g==$gRA83gwxTexfkHoHKT7SsEQnLOvBbb5BetgMPpPI1Ho=:KDxe1jNoBvi4YiCPJFVPcpS87PCeDMeI6ZDXoXte9bE=';
-- CREATE ROLE "dashboard_user";
-- ALTER ROLE "dashboard_user" WITH INHERIT CREATEROLE CREATEDB NOLOGIN REPLICATION NOBYPASSRLS;
-- CREATE ROLE "pgbouncer";
-- ALTER ROLE "pgbouncer" WITH INHERIT NOCREATEROLE NOCREATEDB LOGIN NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:qZypa/a98CaWiQCpVjk9dQ==$CATYRX+tVEUBPTxhGMITEvrJn2FHlSnEa68aXKaJYro=:kNA9E9u/LYgLfH461XHINML7adQeTmbgKMiBrTle7jU=';
-- CREATE ROLE "postgres";
-- ALTER ROLE "postgres" WITH INHERIT CREATEROLE CREATEDB LOGIN REPLICATION BYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:ByxLLDFWrcweOb4jneGqsQ==$7N2n82vxu6ABJi/l6uCy/ijuGyKrkCmFgiD3EE6Fpzc=:ROoD1bvAK8IuDQnS0j8o0Ty4TwEDrTIFyLK3prFX6RQ=';
-- CREATE ROLE "service_role";
-- ALTER ROLE "service_role" WITH INHERIT NOCREATEROLE NOCREATEDB NOLOGIN BYPASSRLS;
-- CREATE ROLE "supabase_admin";
-- ALTER ROLE "supabase_admin" WITH SUPERUSER INHERIT CREATEROLE CREATEDB LOGIN REPLICATION BYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:kcTQab2iBVnDrFOib9AOig==$i8UzRZxHmp/j8YTJ+LZa3+qJnefjSb7FdEe7+KKAnO0=:bAQOzeLLnbefoVn/dIZl/uLs0iydisqm4lwODI/2MoQ=';
-- CREATE ROLE "supabase_auth_admin";
-- ALTER ROLE "supabase_auth_admin" WITH NOINHERIT CREATEROLE NOCREATEDB LOGIN NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:toRAE/VMnLzNXmAaIdz/pg==$zG8HdWqxKtffAtcVsBWHa/WmercOpeD1EZZr19GBQM8=:+wbhLYaW1ENMiS0VDt2Cz3oEcRBNtStI6pjh/SZ8JFA=';
-- CREATE ROLE "supabase_etl_admin";
-- ALTER ROLE "supabase_etl_admin" WITH INHERIT NOCREATEROLE NOCREATEDB LOGIN REPLICATION BYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:b3JDtIIV1uvqt4LHcWj7xQ==$xw3e5AOHDbvuBDYjfyOzUE1fDGjVQP/QjQ6ttRmO/lc=:xSpMBx+oG7wqDA5lCrLhKF88r7GkePFrphFfKhv59BQ=';
-- CREATE ROLE "supabase_privileged_role";
-- ALTER ROLE "supabase_privileged_role" WITH INHERIT NOCREATEROLE NOCREATEDB NOLOGIN NOBYPASSRLS;
-- CREATE ROLE "supabase_read_only_user";
-- ALTER ROLE "supabase_read_only_user" WITH INHERIT NOCREATEROLE NOCREATEDB LOGIN BYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:24eRQKJCiZk/lRjeeuh8qg==$sNXTld1URqYhsTGZhz+QbOyFspEX+oVfewpKPLDmaY8=:8Zw0LtZG6rSXwT8e0UIngRHajTb7lQEhA76h7Zvr28A=';
-- CREATE ROLE "supabase_realtime_admin";
-- ALTER ROLE "supabase_realtime_admin" WITH NOINHERIT NOCREATEROLE NOCREATEDB NOLOGIN NOBYPASSRLS;
-- CREATE ROLE "supabase_replication_admin";
-- ALTER ROLE "supabase_replication_admin" WITH INHERIT NOCREATEROLE NOCREATEDB LOGIN REPLICATION NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:getVJxopUGjMX9BLZGJ3mw==$0YmwqWaaMlyHwrSIng4r5v+BnAXImy0/Mn0oOeiafKU=:KTOpLRctMXr1LCDQU8NkgiskQ5rh7SWG19hwSdR0Y4o=';
-- CREATE ROLE "supabase_storage_admin";
-- ALTER ROLE "supabase_storage_admin" WITH NOINHERIT CREATEROLE NOCREATEDB LOGIN NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:D4KOodr8TldZOjVAB60eOw==$qPkACXHV/hI79f9xT/JnbdMvC+j6f1aaD7vt7aYKTPY=:JkH/K8Df1NBaKwBHFWhTmtRBC3TFac7jI/6W4w7C5CA=';
...
CREATE TABLE "public"."backtest_results" (
    ...
    "total_return_pct" numeric DEFAULT 0 NOT NULL,
    "total_pnl" numeric DEFAULT 0 NOT NULL,
    "max_drawdown_pct" numeric DEFAULT 0 NOT NULL,
    "sharpe_ratio" numeric DEFAULT 0 NOT NULL,
    "avg_trade_duration_hours" numeric DEFAULT 0 NOT NULL,
    "equity_curve" "jsonb" DEFAULT '[]'::"jsonb" NOT NULL,
    "trade_list" "jsonb" DEFAULT '[]'::"jsonb" NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL
);
...
CREATE TABLE "public"."signals" (
    ...
    "timeframe" "text" DEFAULT '1h'::"text" NOT NULL,
    "reason" "text",
    "status" "public"."signal_status" DEFAULT 'pending'::"public"."signal_status" NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL
);
...
CREATE TABLE "public"."strategies" (
    ...
    "status" "public"."strategy_status" DEFAULT 'inactive'::"public"."strategy_status" NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "strategy_params" "jsonb",
    "stop_loss_pct" numeric(6,2) DEFAULT NULL::numeric,
    "take_profit_pct" numeric(6,2) DEFAULT NULL::numeric,
    "position_size_pct" numeric(6,2) DEFAULT NULL::numeric,
    "tp1_pct" numeric(6,2) DEFAULT NULL::numeric,
    "tp2_pct" numeric(6,2) DEFAULT NULL::numeric,
    "tp3_pct" numeric(6,2) DEFAULT NULL::numeric,
    "tp1_size_pct" numeric(6,2) DEFAULT NULL::numeric,
    "tp2_size_pct" numeric(6,2) DEFAULT NULL::numeric,
    "tp3_size_pct" numeric(6,2) DEFAULT NULL::numeric,
    "timeframe" character varying(10) DEFAULT '1h'::character varying,
...
CREATE TABLE "public"."user_settings" (
    ...
    "trading_mode" "text" DEFAULT 'spot'::"text" NOT NULL,
    "min_confidence" integer DEFAULT 70 NOT NULL,
    "stop_loss_pct" numeric DEFAULT 2.0 NOT NULL,
    "take_profit_pct" numeric DEFAULT 4.0 NOT NULL,
    "position_size_pct" numeric DEFAULT 5.0 NOT NULL,
    "max_open_trades" integer DEFAULT 5 NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "use_testnet" boolean DEFAULT true NOT NULL,
...
--
-- Name: signals set_signals_updated_at; Type: TRIGGER; Schema: public; Owner: -
--
...
CREATE TRIGGER "set_strategies_updated_at" BEFORE UPDATE ON "public"."strategies" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();


--
-- Name: trades set_trades_updated_at; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: backtest_results backtest_results_strategy_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."backtest_results"
    ADD CONSTRAINT "backtest_results_strategy_id_fkey" FOREIGN KEY ("strategy_id") REFERENCES "public"."strategies"("id") ON DELETE SET NULL;
...
ALTER TABLE ONLY "public"."backtest_results"
    ADD CONSTRAINT "backtest_results_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."profiles"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."signals"
    ADD CONSTRAINT "signals_strategy_id_fkey" FOREIGN KEY ("strategy_id") REFERENCES "public"."strategies"("id") ON DELETE SET NULL;


--
-- Name: signals signals_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: backtest_results Admins full access to backtest results; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Admins full access to backtest results" ON "public"."backtest_results" TO "authenticated" USING (("public"."get_user_role"("auth"."uid"()) = 'admin'::"public"."user_role"));


--
-- Name: user_settings Admins full access to settings; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Admins full access to settings" ON "public"."user_settings" TO "authenticated" USING (("public"."get_user_role"("auth"."uid"()) = 'admin'::"public"."user_role"));


--
-- Name: signals Admins full access to signals; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Admins full access to signals" ON "public"."signals" TO "authenticated" USING (("public"."get_user_role"("auth"."uid"()) = 'admin'::"public"."user_role"));


--
-- Name: strategies Admins full access to strategies; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Admins full access to strategies" ON "public"."strategies" TO "authenticated" USING (("public"."get_user_role"("auth"."uid"()) = 'admin'::"public"."user_role"));


--
-- Name: trades Admins full access to trades; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Admins full access to trades" ON "public"."trades" TO "authenticated" USING (("public"."get_user_role"("auth"."uid"()) = 'admin'::"public"."user_role"));
...
--
-- Name: market_scans Anon can view market scans; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Anon can view market scans" ON "public"."market_scans" FOR SELECT TO "anon" USING (true);


--
-- Name: market_scans Anyone can view market scans; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Anyone can view market scans" ON "public"."market_scans" FOR SELECT TO "authenticated" USING (true);
...
CREATE POLICY "Users can delete own backtest results" ON "public"."backtest_results" FOR DELETE TO "authenticated" USING (("user_id" = "auth"."uid"()));
...
--
-- Name: signals Users can delete own signals; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Users can delete own signals" ON "public"."signals" FOR DELETE TO "authenticated" USING (("user_id" = "auth"."uid"()));


--
-- Name: strategies Users can delete own strategies; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Users can delete own strategies" ON "public"."strategies" FOR DELETE TO "authenticated" USING (("user_id" = "auth"."uid"()));
...
--
-- Name: backtest_results Users can insert own backtest results; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Users can insert own backtest results" ON "public"."backtest_results" FOR INSERT TO "authenticated" WITH CHECK (("user_id" = "auth"."uid"()));
...
--
-- Name: signals Users can insert own signals; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Users can insert own signals" ON "public"."signals" FOR INSERT TO "authenticated" WITH CHECK (("user_id" = "auth"."uid"()));


--
-- Name: strategies Users can insert own strategies; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Users can insert own strategies" ON "public"."strategies" FOR INSERT TO "authenticated" WITH CHECK (("user_id" = "auth"."uid"()));
...
--
-- Name: signals Users can update own signals; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Users can update own signals" ON "public"."signals" FOR UPDATE TO "authenticated" USING (("user_id" = "auth"."uid"())) WITH CHECK (("user_id" = "auth"."uid"()));


--
-- Name: strategies Users can update own strategies; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Users can update own strategies" ON "public"."strategies" FOR UPDATE TO "authenticated" USING (("user_id" = "auth"."uid"())) WITH CHECK (("user_id" = "auth"."uid"()));
...
--
-- Name: backtest_results Users can view own backtest results; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Users can view own backtest results" ON "public"."backtest_results" FOR SELECT TO "authenticated" USING (("user_id" = "auth"."uid"()));
...
--
-- Name: signals Users can view own signals; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Users can view own signals" ON "public"."signals" FOR SELECT TO "authenticated" USING (("user_id" = "auth"."uid"()));


--
-- Name: strategies Users can view own strategies; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Users can view own strategies" ON "public"."strategies" FOR SELECT TO "authenticated" USING (("user_id" = "auth"."uid"()));
...
--
-- Name: market_scans; Type: ROW SECURITY; Schema: public; Owner: -
--
