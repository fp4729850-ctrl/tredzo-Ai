...
**Endpoint:** `GET https://app-ckp4ck3tg3r5-api-AalZze1qEWML.gateway.appmedo.com/v1/news/all`
...
async function getFinanceNews(params: NewsParams = {}): Promise<NewsResponse> {
  ...
  const response = await fetch(
    `https://app-ckp4ck3tg3r5-api-AalZze1qEWML.gateway.appmedo.com/v1/news/all?${query.toString()}`,
