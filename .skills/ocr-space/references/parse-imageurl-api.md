...
| Property | Value |
|----------|-------|
| Endpoint | `GET https://app-ckp4ck3tg3r5-api-m9xKXDbRplNa.gateway.appmedo.com/parse/imageurl` |
...
async function ocrParseImageUrl(
  ...
  const response = await fetch(
    `https://app-ckp4ck3tg3r5-api-m9xKXDbRplNa.gateway.appmedo.com/parse/imageurl?${params.toString()}`,
    {
      method: "GET",
      headers: {
